...
# with command line options: Configuration/GenProduction/python/TSG-Phase2HLTTDRWinter20wmLHEGS-00033-fragment.py --fileout file:step1_lhe.root --mc --eventcontent RAWSIM,LHE --customise SLHCUpgradeSimulations/Configuration/aging.customise_aging_1000,Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM,LHE --conditions 110X_mcRun4_realistic_v3 --beamspot HLLHC14TeV --step LHE,GEN,SIM --nThreads 8 --geometry Extended2026D49 --era Phase2C9 --python_filename step1_lhe_cfg.py --no_exec --customise_commands process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=int(89) -n 100
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/TSG-Phase2HLTTDRWinter20wmLHEGS-00033-fragment.py nevts:{}'.format(options.maxEvents)),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string(options.filelhe),
...
process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=int(89)
